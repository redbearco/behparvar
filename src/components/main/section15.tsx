...
import Tec1 from '../../../public/images/circle/participation.png';
import Back1 from '../../../public/images/back/participation.jpg';


const Section15 = () => {
    const [height, width] = useWindowResize();
    return (
        <div id="participation" className="position-relative w-100 mt-5 Section5">
                    ...
                    <section className="row my-3 my-md-3 my-lg-5 my-xl-5">
                        <div className="col-12 col-md-12 col-lg-6 col-xl-6 d-flex justify-content-center flex-column order-2 order-md-2 order-lg-1 order-xl-1 mb-3 mb-md-3 mb-lg-0 mb-xl-0">
                            <header className="position-relative w-100 d-flex align-items-center justify-content-center mb-4 title">
                                <h4 className="font-size-32 custom-light-blue ps-3 zindex-1">مشارکت در تولید</h4>
                            </header>
                            <p className='font-size-18 color-grey text-justify'>شرکت بهپرور با همکاری فعالانه با تولیدکنندگان و مرغداران، زنجیره‌ای یکپارچه از تولید تا عرضه ایجاد کرده است. این مشارکت ارزشمند، تضمینی برای ارائه محصولاتی با کیفیت و مطابق با استانداردهای جهانی است.</p>
                            <div className="w-100 mt-4 d-flex justify-content-center">
                                <Link className='d-flex align-items-center justify-content-center text-white bg-custom-blue br-32 seemore' href={`/tolid`} title={``}>مشارکت در تولید</Link>
                            </div>
                        </div>
